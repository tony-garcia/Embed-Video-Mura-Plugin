...
<p>The Embed Video plugin allows you to easily embed videos from popular video sharing services (YouTube, Yahoo, Vimeo, Metacafe, LiveLeak) in your
...
<table border="1">
  ...
  <tr>
    ...
    YouTube, Vimeo, Yahoo, Metacafe, LiveLeak
    </td>
  </tr>
  <tr>
    <td>videoid</td>
...
<p><strong>LiveLeak</strong>: The following is an example of a video URL from www.liveleak.com:</p>
<pre>http://www.liveleak.com/view?i=d73_1280863671</pre><br />
<p>The video id is the text that follows ?i= in the URL (in this case, d73_1280863671). Therefore, to embed the example video, you could type in:</p>
<pre>[EmbedVideo from:liveleak videoid:d73_1280863671]</pre><br />
<h3>Important</h3>
